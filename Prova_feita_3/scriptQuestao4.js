function revelar(){
    ...
    if (imagem){
        imagem.src='Prova_feita_3/_vinicius_junior.png'; 
        imagem.alt='Vinícius Júnior';
    }
    if (spanNome) {
        spanNome.innerHTML = 'Vinícius José Paixão de Oliveira Júnior <span id="Rank" class="badge text-bg-success">9,5</span>';
    }
    if (spanData) {
